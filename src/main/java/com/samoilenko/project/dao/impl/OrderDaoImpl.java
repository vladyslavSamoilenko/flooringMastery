...
public class OrderDaoImpl implements OrderDao {
    ...
    public void addOrder(Order order) {
        String query = "INSERT INTO Orders (OrderNumber, CustomerName, State, TaxRate, ProductType, Area, CostPerSquareFoot, LaborCostPerSquareFoot, MaterialCost, LaborCost, Tax, Total) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
